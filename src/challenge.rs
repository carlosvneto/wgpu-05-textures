...
impl State {
    async fn new(window: Window) -> Self {
        ...
        let diffuse_bytes = include_bytes!("holy-spirit-01.png");
        let diffuse_texture =
            texture::Texture::from_bytes(&device, &queue, diffuse_bytes, "holy-spirit-01.png").unwrap();
        ...
        let cartoon_bytes = include_bytes!("holy-spirit-02.png");
        let cartoon_texture =
            texture::Texture::from_bytes(&device, &queue, cartoon_bytes, "holy-spirit-02.png")
                .unwrap();
...
async fn run() {
    ...
    let window = WindowBuilder::new()
        .with_title("wGPU Two Textures - press and hold space bar")
        .build(&event_loop)
        .unwrap();
